...
class Aplicacion:
    ...
    def __init__(self):
        ...
        self.marco=ttk.Frame(self.__ventana,relief="raised", padding=(40,50))
        ...
        self.__mostrar.set('')
        #Cabecera
        self.tituloLbl=tk.Label(self.__ventana,text='Cálculo de IVA',bg='light blue',borderwidth=1,relief='solid',width=41)
